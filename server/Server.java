...
public class Server {
    ...
    static boolean[] isConnected = new boolean[5];  
    static String[] sessionToken = new String[5];    
    ...
    public static void main(String args[])
        ...
        for (;;) {
            ...
            switch (parts[0]) {
                case "Create":
                    reponse = createuser.createuser(parts);
                    break;
                case "Login":
                    reponse = ConnectUser.connectUser(parts);
                    break;
                case "Message":
                    reponse = envoyerMessage(parts);
                    break;
                case "Read":
                    reponse = lireMessages(parts);
                    break;
                default:
                    reponse = "400,Unknown command";
            }
            // Renvoyer au client
